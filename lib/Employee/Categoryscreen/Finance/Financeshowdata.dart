...
class Financeshowdata extends StatefulWidget {
  final String? projectName;
  final int? unreadCount;
  final String? highlightedTaskId;

  const Financeshowdata({this.projectName, this.unreadCount,this.highlightedTaskId,});

  @override
  State<Financeshowdata> createState() => _FinanceshowdataState();
}
class _FinanceshowdataState extends State<Financeshowdata> {
  String searchQuery = "";
  DateTime? startDate;
  DateTime? endDate;
                ...
                builder: (context, snapshot) {
                  ...
                  return StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance
                        .collection('TaskAssign')
                        .where('department', isEqualTo: 'Finance')
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          labelStyle: const TextStyle(color: Colors.white, fontFamily: "Times New Roman", fontWeight: FontWeight.bold),
