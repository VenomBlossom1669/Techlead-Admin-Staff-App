...
Widget buildGradientCalendar(BuildContext context, DateTime selectedDate, Function(DateTime) onDateSelected) {
  ...
  DateTime firstDay = DateTime(today.year, today.month, today.day); // Start from today
  DateTime lastDay = DateTime(today.year + 5, 12, 31); // 5 years into the future

  DateTime safeFocusedDay = selectedDate.isBefore(firstDay) ? firstDay : selectedDate;
