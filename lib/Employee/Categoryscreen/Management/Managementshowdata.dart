...
class Managementshowdata extends StatefulWidget {
  final String? projectName;
  final int? unreadCount;
  final String? highlightedTaskId;

  const Managementshowdata({this.projectName, this.unreadCount,this.highlightedTaskId,});

  @override
  State<Managementshowdata> createState() => _ManagementshowdataState();
}

class _ManagementshowdataState extends State<Managementshowdata> {
  String searchQuery = "";
  DateTime? startDate;
  DateTime? endDate;
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Assigned Tasks From Admin",
            style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold,fontSize: 14,fontFamily: "Times New Roman")),
        centerTitle: true,
        backgroundColor: Colors.blue.shade900,
                ...
                builder: (context, snapshot) {
                  ...
                  return StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance
                        .collection('TaskAssign')
                        .where('department', isEqualTo: 'Management')
