...
class Accountshowdata extends StatefulWidget {
  ...
  const Accountshowdata({this.projectName, this.unreadCount,this.highlightedTaskId,});

  @override
  State<Accountshowdata> createState() => _AccountshowdataState();
}

class _AccountshowdataState extends State<Accountshowdata> {
  String searchQuery = "";
  DateTime? startDate;
  DateTime? endDate;
              ...
              actions: [
                TextButton(
                  ...
                  child: Text(
                    "Cancel",
                    style: TextStyle(
                      color: _isUpdating ? Colors.grey : Colors.white,
                    ),
                  ),
                ),
                ElevatedButton(
                              ...
                              child: Card(
                                ...
                                child: Container(
                                  ...
                                  children: [
                                    ...
                                    _buildTaskDetail('Admin Task Description', task['taskDescription']),
