...
class DailyReportRecordOfReception extends StatefulWidget {
  const DailyReportRecordOfReception({super.key});

  @override
  State<DailyReportRecordOfReception> createState() =>
      _DailyReportRecordOfReceptionState();
}

class _DailyReportRecordOfReceptionState
    extends State<DailyReportRecordOfReception> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where("Service_department", isEqualTo: "Reception")
