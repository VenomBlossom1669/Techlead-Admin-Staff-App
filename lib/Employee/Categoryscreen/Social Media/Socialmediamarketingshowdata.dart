...
class Socialmediamarketingshowdata extends StatefulWidget {
  final String? projectName;
  final int? unreadCount;
  final String? highlightedTaskId;

  const Socialmediamarketingshowdata({this.projectName, this.unreadCount,this.highlightedTaskId,});

  @override
  State<Socialmediamarketingshowdata> createState() =>
      _SocialmediamarketingshowdataState();
}

class _SocialmediamarketingshowdataState
    extends State<Socialmediamarketingshowdata> {
  String searchQuery = "";
  DateTime? startDate;
  DateTime? endDate;
              ...
              builder: (context, snapshot) {
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      .collection('TaskAssign')
                      .where('department', isEqualTo: 'Social Media')
