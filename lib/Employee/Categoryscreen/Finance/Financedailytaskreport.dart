...
class Financedailytaskreport extends StatefulWidget {
  const Financedailytaskreport({super.key});

  @override
  State<Financedailytaskreport> createState() =>
      _FinancedailytaskreportState();
}

class _FinancedailytaskreportState
    extends State<Financedailytaskreport> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where("Service_department", isEqualTo: "Finance")
