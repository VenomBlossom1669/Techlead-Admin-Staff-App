...
class Receptionshowdata extends StatefulWidget {
  final String? projectName;
  final int? unreadCount;
  final String? highlightedTaskId;

  const Receptionshowdata({this.projectName, this.unreadCount,this.highlightedTaskId,});


  @override
  State<Receptionshowdata> createState() => _ReceptionshowdataState();
}

class _ReceptionshowdataState extends State<Receptionshowdata> {
  String searchQuery = "";
  DateTime? startDate;
  DateTime? endDate;
              ...
              builder: (context, snapshot) {
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      .collection('TaskAssign')
                      .where('department', isEqualTo: 'Reception')
