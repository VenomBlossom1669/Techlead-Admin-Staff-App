...
class Hrreceiveddata extends StatefulWidget {
  final String? projectName;
  final int? unreadCount;
  final String? highlightedTaskId;

  const Hrreceiveddata({this.projectName, this.unreadCount,this.highlightedTaskId,});

  @override
  State<Hrreceiveddata> createState() => _HrreceiveddataState();
}

class _HrreceiveddataState extends State<Hrreceiveddata> {
  String searchQuery = "";
  DateTime? startDate;
  DateTime? endDate;
                ...
                builder: (context, snapshot) {
                  ...
                  return StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance
                          .collection('TaskAssign')
                          .where('department', isEqualTo: 'Human Resource')
