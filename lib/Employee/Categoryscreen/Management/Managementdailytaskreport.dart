...
class Managementdailytaskreport extends StatefulWidget {
  const Managementdailytaskreport({super.key});

  @override
  State<Managementdailytaskreport> createState() =>
      _ManagementdailytaskreportState();
}

class _ManagementdailytaskreportState
    extends State<Managementdailytaskreport> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where("Service_department", isEqualTo: "Management")
