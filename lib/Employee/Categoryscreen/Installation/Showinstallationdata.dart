...
import 'package:techlead/Admin/Installation/Edit_Installation_Page/edit_installation_page.dart';
...
class ShowEmployeeinstallationdata extends StatefulWidget {
  @override
  _ShowEmployeeinstallationdataState createState() =>
      _ShowEmployeeinstallationdataState();
}

class _ShowEmployeeinstallationdataState
    extends State<ShowEmployeeinstallationdata> {
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (filteredDocs.isEmpty) {
                  return const Center(
                    child: Text(
                      "No reports match your search/date range!",
                      style: TextStyle(
