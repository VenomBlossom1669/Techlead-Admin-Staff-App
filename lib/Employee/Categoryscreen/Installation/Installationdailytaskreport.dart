...
class DailyReportRecordOfInstallation extends StatefulWidget {
  const DailyReportRecordOfInstallation({super.key});

  @override
  State<DailyReportRecordOfInstallation> createState() =>
      _DailyReportRecordOfReceptionState();
}

class _DailyReportRecordOfReceptionState
    extends State<DailyReportRecordOfInstallation> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where("Service_department", isEqualTo: "Installation")
