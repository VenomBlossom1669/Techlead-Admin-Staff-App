...
class Accountdailytaskreport extends StatefulWidget {
  const Accountdailytaskreport({super.key});

  @override
  State<Accountdailytaskreport> createState() =>
      _AccountdailytaskreportState();
}
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where("Service_department", isEqualTo: "Account")
