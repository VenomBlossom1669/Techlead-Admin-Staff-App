...
class AssignedTaskForInstallation extends StatefulWidget {
  final String? projectName;
  final int? unreadCount;
  final String? highlightedTaskId;

  const AssignedTaskForInstallation({this.projectName, this.unreadCount, this.highlightedTaskId});

  @override
  State<AssignedTaskForInstallation> createState() =>
      _AssignedTaskForInstallationState();
}

class _AssignedTaskForInstallationState
    extends State<AssignedTaskForInstallation> {
  String searchQuery = "";
  DateTime? startDate;
  DateTime? endDate;
                ...
                builder: (context, snapshot) {
                  ...
                  return StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance
                        .collection('TaskAssign')
                        .where('department', isEqualTo: 'Installation')
                    ...
                    builder: (context, taskSnapshot) {
                      ...
                      if (assignedTasks.isEmpty) {
                        return const Center(
                            child: Text("No tasks available between these dates.",
                                style: TextStyle(
                                    fontSize: 16, fontFamily: "Times New Roman")));
                      }
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isUnreadHighlighted = task['isUnread'] == true &&
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (task['siteLocation'] != null)
                                      _buildTaskDetail(
                                          'Site Location', task['siteLocation']),
                                    _buildTaskDetail(
                                    ...
                                    _buildTaskDetail(
                                        'Deadline Time', task['deadlinetime']),
                                    _buildTaskDetail('Employee Task Description',
                                        task['employeeDescription']),
          ...
          text: TextSpan(
            ...
            children: [
              TextSpan(
                text: displayText,
                style: TextStyle(
                  color: isLocationField ? Colors.lightBlueAccent : Colors.white,
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  fontFamily: "Times New Roman",
                  decoration:
                  isLocationField ? TextDecoration.underline : TextDecoration.none,
                ),
              ),
            ],
          ),
